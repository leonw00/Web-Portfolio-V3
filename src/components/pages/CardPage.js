                ...
                <ul className = "cards_items">
                    <Fade bottom>
                        ...
                        <CardItem
                            ...
                            text = "A web application where users could post stories online anonymously. The user has the option to register and login to track what they have posted. The site is mainly built in Django with postgresql as its database. It is deployed to Heroku with the use of Docker as its container."
                            live = "https://gentle-plateau-42680.herokuapp.com/"
                            code = "https://github.com/leonw00/secret-stories"
                            languages = {["django", "python", "postgresql", "docker"]}
                        />
                        ...
                        <CardItem
                            ...
                            languages = {["java", "mongodb", "mockito"]}
                        />
